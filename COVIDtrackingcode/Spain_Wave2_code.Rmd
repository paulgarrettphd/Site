...
The following provides a snapshot of the results from the second wave of data collected in Spain for the project 'establishing the social licence for tracking technologies'. Data was collected from August 8th - August 12th 2020. Click here to get the [code](https://github.com/paulgarrettphd/Site/blob/master/COVIDtrackingcode/Spain_Wave2_code.Rmd) and [functions](https://github.com/paulgarrettphd/Site/blob/master/COVIDtrackingcode/Functions.R) for this analysis, or click to see the [international results](https://stephanlewandowsky.github.io/UKsocialLicence/).
